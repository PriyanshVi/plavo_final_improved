...
const Contact: React.FC = () => (
  <section className="contact" id="contact">
    ...
    <p>We are always ready to listen to you first. For business inquiries, reach out via:</p>
    <div className="contact-form" style={{ maxWidth: 400, margin: '2rem auto 0 auto', textAlign: 'left' }}>
      <div style={{ marginBottom: '1.2rem', display: 'flex', alignItems: 'center', gap: '0.7rem' }}>
        <PhoneIcon />
        <a className="card-btn" href="tel:8076727357">Call: 8076727357</a>
      </div>
      <div style={{ marginBottom: '1.2rem', display: 'flex', alignItems: 'center', gap: '0.7rem' }}>
        <WhatsAppIcon />
        <a className="whatsapp-btn" href="https://wa.me/918076727357" target="_blank" rel="noopener noreferrer">Chat on WhatsApp</a>
      </div>
      <div style={{ color: '#555', fontSize: '1rem', marginTop: '1.2rem' }}>
